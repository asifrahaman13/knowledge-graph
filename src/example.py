...
def example_build_and_search():
    ...
    # PDF file path
    PDF_PATH = os.getenv("PDF_PATH", "../note.pdf")  # Default to note.pdf in parent directory
    ...
    try:
        ...
        print("   Please set PDF_PATH environment variable or place note.pdf in parent directory")
        return
